# LimaCharlie Permissions Reference
...
| Permission    | Description                       | Assignable |
|---------------|-----------------------------------|------------|
...
| cloudsensor.set     | Create and modify cloud sensor configs | ✅          |
...
| replicant.task | Execute tasks on replicant services | ✅          |
...
| job.set    | Create and schedule jobs    | ✅          |
