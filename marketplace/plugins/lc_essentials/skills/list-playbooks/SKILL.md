---
name: list-playbooks
description: List all playbooks in a LimaCharlie organization. Use this skill when users need to view, inventory, audit, or manage automation playbooks. Playbooks define automated response workflows that execute when certain conditions are met. Shows playbook definitions, enabled status, tags, comments, and metadata for all playbooks. Essential for understanding automated incident response and workflow automation.
