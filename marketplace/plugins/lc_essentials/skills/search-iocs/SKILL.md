---
name: search-iocs
description: Search for Indicators of Compromise (IOCs) across the organization including file hashes, domains, IPs, file paths, usernames, and more. Returns summary occurrence counts or specific sensor locations. Supports wildcard matching. Use for threat hunting, IOC pivoting, compromise assessment, and tracking indicator prevalence.
...
mcp__limacharlie__lc_api_call(
  ...
  endpoint="api",
  method="POST",
  path="/insight/c7e8f940-1234-5678-abcd-1234567890ab/search",
  body={
    "type": "file_hash",
    "value": "abc123def456...",
