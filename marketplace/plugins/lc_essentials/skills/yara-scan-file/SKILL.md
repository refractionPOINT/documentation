---
name: yara-scan-file
description: Scan a specific file on disk with YARA rules for malware detection and file analysis. Takes YARA rule content or rule name and file path. Use for real-time file malware scanning, suspicious file validation, IOC matching on disk artifacts, and identifying malicious files during investigations.
allowed-tools: mcp__limacharlie__yara_scan_file, Read
---
