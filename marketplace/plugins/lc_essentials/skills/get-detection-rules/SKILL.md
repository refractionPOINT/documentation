...
description: Get all Detection and Response (D&R) rules from all namespaces in the organization. Returns complete rule configurations from general, managed, and service namespaces. Use for rule auditing, compliance review, detection coverage analysis, rule inventory, or exporting entire detection stack.
