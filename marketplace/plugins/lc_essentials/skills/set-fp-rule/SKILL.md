---
name: set-fp-rule
description: Create or update a false positive rule to filter unwanted detections. Add FP rules to suppress benign alerts and reduce detection noise. Use when users need to create, update, configure, or manage false positive rules, tune detection systems, filter known-safe activity, or reduce alert fatigue.
