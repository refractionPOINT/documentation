...
description: List all saved LCQL queries in the organization's hive storage. Returns query names, LCQL strings, descriptions, tags, and metadata. Use to discover available saved queries, manage query library, review frequently used searches, and access pre-defined hunting queries.
