---
name: find-strings
description: Search for specific strings across all process memory on a live sensor. Takes comma-separated string list and returns which processes contain those strings. Use for targeted string hunting, credential searching, C2 domain discovery, and efficiently locating specific indicators across all running processes during investigations.
allowed-tools: mcp__limacharlie__find_strings, Read
---
