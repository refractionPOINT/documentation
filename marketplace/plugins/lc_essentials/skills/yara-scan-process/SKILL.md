---
name: yara-scan-process
description: Scan a specific process memory with YARA rules for malware detection, threat hunting, and IOC matching. Takes YARA rule content or rule name and process ID. Use for real-time malware identification, memory-resident threat detection, fileless malware hunting, and validating suspicious process behavior against threat signatures.
allowed-tools: mcp__limacharlie__yara_scan_process, Read
---
