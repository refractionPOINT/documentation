...
description: Retrieve a specific saved LCQL query by name from the organization's hive storage. Returns complete query details including LCQL string, description, tags, and metadata. Use to view query definition before execution, inspect query logic, or copy query for modification.
