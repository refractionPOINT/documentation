---
name: set-dr-managed-rule
description: Create or update a managed Detection & Response rule in the managed namespace. Add new managed detection rules or modify existing ones with detection logic and response actions. Use when users need to create, update, modify, or configure managed detection rules, automate detection engineering, import rules, or manage detection rule lifecycle in the managed namespace.
