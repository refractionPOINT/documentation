---
name: run-lcql-query
description: Execute LimaCharlie Query Language (LCQL) queries to search and analyze historical telemetry data across events, detections, and audit logs. Supports complex filtering, aggregation, timeframes, and pagination. Use for security investigations, threat hunting, compliance audits, forensic analysis, pattern detection, and behavioral analytics across your entire sensor fleet.
...
mcp__limacharlie__lc_api_call(
  ...
  endpoint="api",
  method="POST",
  path="/insight/c7e8f940-1234-5678-abcd-1234567890ab/lcql",
  body={
