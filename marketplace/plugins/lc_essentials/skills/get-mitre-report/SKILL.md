---
name: get-mitre-report
description: Get MITRE ATT&CK coverage report showing detection rule coverage across tactics and techniques. View detection coverage mapped to MITRE ATT&CK framework. Use when users need to assess, review, audit, or report on detection coverage, analyze security posture, identify detection gaps, or demonstrate compliance with threat detection frameworks.
