...
```
mcp__plugin_lc-essentials_limacharlie__generate_detection_summary(
  query='{"detect": {"event": "NEW_PROCESS", "routing": {"hostname": "LAPTOP-01", ...}}, "cat": "suspicious_powershell", ...}'
)
```

**Tool Details:**
- Tool: `mcp__plugin_lc-essentials_limacharlie__generate_detection_summary`
- Parameters:
...
```json
{
  "summary": "# Detection Summary: Suspicious PowerShell Execution\n\n## Overview\nA suspicious PowerShell command was detected on LAPTOP-01 at 2024-01-20 14:35:22 UTC.\n\n## Details\n- **Host**: LAPTOP-01\n- **User**: john.doe\n- **Process**: powershell.exe\n- **Command Line**: `powershell.exe -enc SGVsbG8gV29ybGQ=`\n\n## Analysis\nThis detection triggered because PowerShell was executed with the `-enc` parameter, which is used to run encoded (Base64) commands. This technique is commonly used by attackers to obfuscate malicious commands and evade detection.\n\nThe encoded command decodes to: `Hello World`\n\nWhile this specific example appears benign, encoded PowerShell is a known indicator of compromise and should be investigated.\n\n## Recommended Actions\n1. Investigate the user's recent activity\n2. Check for other suspicious PowerShell executions on this host\n3. Review the decoded command for malicious intent\n4. Consider isolating the endpoint if additional indicators are found"
}
```
...
```
AI-Generated Detection Summary:

# Detection Summary: Suspicious PowerShell Execution
...
---
Note: This summary was generated by AI. Verify critical details from the original event data before taking action.
```
...
```json
{
  "summary": "# Detection Summary: Suspicious Network Connection\n\n## Overview\nA suspicious outbound network connection was detected...\n\n## Analysis\nThe connection to port 4444 is concerning as this is a common port for reverse shells and command-and-control channels..."
}
```
...
```json
{
  "summary": "# Incident Summary: Multi-Stage Attack\n\n## Overview\nA coordinated attack involving lateral movement and credential access was detected...\n\n## Attack Timeline\n1. Initial credential access detected at...\n2. Lateral movement to additional hosts...\n3. ...\n\n## Indicators of Compromise\n- ...\n\n## Recommended Response\n1. Isolate affected systems\n2. Reset compromised credentials\n3. ..."
}
```
