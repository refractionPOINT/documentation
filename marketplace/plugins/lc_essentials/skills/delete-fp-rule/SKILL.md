---
name: delete-fp-rule
description: Delete a false positive rule by name from the organization. Remove unwanted or outdated FP rules that filter detections. Use when users need to remove, delete, clean up, or disable false positive rules, restore filtered detections, or manage FP rule lifecycle.
