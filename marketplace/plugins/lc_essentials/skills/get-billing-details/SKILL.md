...
description: Get detailed billing information for a LimaCharlie organization including subscription plan, payment method, billing contact, and account status. Use this skill when reviewing billing configuration, updating payment information, checking subscription status, or troubleshooting billing issues. Requires billing endpoint access.
