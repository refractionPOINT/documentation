---
name: delete-yara-rule
description: Delete a YARA rule from the organization by name. Remove unwanted or outdated YARA malware detection rules. Use when users need to remove, delete, clean up, or decommission YARA rules, manage rule lifecycle, or disable malware signatures.
