---
name: get-drivers
description: Get list of installed drivers (kernel modules) from a live sensor including driver names, file paths, versions, and signatures. Use for rootkit detection, driver-based malware identification, kernel security auditing, and investigating low-level persistence mechanisms during security investigations.
allowed-tools: mcp__limacharlie__get_drivers, Read
---
