---
name: get-playbook
description: Get a specific playbook by name from a LimaCharlie organization. Use this skill when users need to view, inspect, or retrieve detailed workflow definition for a particular playbook. Playbooks define automated response workflows with steps, triggers, conditions, and actions. Returns complete playbook definition, enabled status, tags, comments, and metadata including creation time and last modification.
