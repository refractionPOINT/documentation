---
name: delete-dr-managed-rule
description: Delete a managed Detection & Response rule by name from the managed namespace. Remove unwanted, outdated, or incorrect managed detection rules from the organization. Use when users need to remove, delete, clean up, or disable managed detection rules, manage rule lifecycle, or decommission automated detections.
