---
name: get-secret
description: Retrieve a secret value from LimaCharlie secure storage. Use with extreme caution when users absolutely need to see stored credentials like API keys, passwords, tokens, or access keys. Returns the actual secret value along with metadata. Only use when necessary for troubleshooting, verification, or migration. Secrets are encrypted at rest and should be handled securely.
...
**Success (200-299):**
- Secret value is in `body.data.value`
