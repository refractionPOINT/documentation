---
name: dir-list
description: List directory contents on a live sensor with wildcard support and recursive depth control. Returns file names, paths, sizes, timestamps, and attributes. Use for file system exploration, finding dropped files, enumerating directories, investigating file locations, and discovering malicious artifacts during security investigations.
allowed-tools: mcp__limacharlie__dir_list, Read
---
