...
description: Get Windows registry keys and values from a live sensor for forensic analysis and investigation. Windows-only. Takes registry path and returns keys, values, and data. Use for registry forensics, malware artifact collection, persistence detection, configuration analysis, and investigating registry-based malware during security investigations.
allowed-tools: mcp__limacharlie__get_registry_keys, Read
---
