...
description: Get detailed usage statistics for a LimaCharlie organization including sensor counts, data ingestion metrics, event volumes, API usage, and resource consumption. Use this skill when monitoring usage, optimizing costs, planning capacity, analyzing workload patterns, or preparing for billing reviews.
