---
name: get-fp-rules
description: Get all false positive rules configured in the organization. List FP rules that filter out benign detections to reduce alert noise. Use when users need to view, audit, inventory, or review false positive rules, check noise reduction filters, or manage detection tuning configurations.
