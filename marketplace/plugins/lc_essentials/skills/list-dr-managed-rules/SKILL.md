---
name: list-dr-managed-rules
description: List all managed Detection & Response rules in the organization. Managed rules are detection rules stored in the 'managed' namespace, typically created through automation or imported from rule packs. Use this skill when users need to view, audit, inventory, or review their managed detection rules, check what automated detections are active, or analyze detection coverage from managed rule sources.
