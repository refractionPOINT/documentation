---
name: list-reliable-tasks
description: List all pending reliable tasks in the organization. View active tasks, monitor execution status, track task delivery, and audit queued commands. Use to verify task creation, monitor fleet-wide operations, check pending tasks, or troubleshoot reliable tasking during incident response and investigations.
