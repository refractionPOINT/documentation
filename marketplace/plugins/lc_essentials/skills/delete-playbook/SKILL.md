...
description: Delete an automation playbook from a LimaCharlie organization. Use this skill when users need to remove, delete, or clean up playbooks. Permanently removes the playbook workflow from the Hive. Use with caution as this action cannot be undone. Useful for decommissioning automation workflows or removing obsolete playbooks.
...
- Endpoint: `api`
- Method: `DELETE`
- Path: `/hive/playbook/global/{playbook_name}`
