---
name: list-yara-rules
description: List all YARA rules configured in the organization for malware detection and file scanning. View YARA rule sources, their metadata, and configuration. Use when users need to inventory, audit, review, or manage YARA rules for malware hunting, file analysis, or threat detection across sensors.
