---
name: delete-sensor
description: Permanently delete a sensor from the organization. Removes all sensor data, configuration, and history. Use for decommissioned systems, permanent removal, cleanup, or when a sensor should no longer be managed. This is irreversible - deleted sensors cannot be recovered.
