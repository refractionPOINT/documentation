...
description: Get detailed information about a specific LimaCharlie sensor including hostname, platform, IP addresses, tags, installation details, online status, and isolation state. Use when investigating a specific sensor, checking sensor health, verifying sensor configuration, or gathering sensor metadata for incident response and troubleshooting.
