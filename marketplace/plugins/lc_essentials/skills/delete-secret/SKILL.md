---
name: delete-secret
description: Delete a secret from LimaCharlie secure storage to remove stored credentials. Use this skill when users need to remove API keys, passwords, tokens, or other sensitive data that are no longer needed. Deletion is immediate and permanent. Any configurations referencing the deleted secret will fail. Use for cleanup, security rotation, or removing compromised credentials.
...
mcp__limacharlie__lc_api_call(
  ...
  endpoint="api",
  method="DELETE",
  path="/hive/secret/c7e8f940-1234-5678-abcd-1234567890ab/old-webhook-key"
)
```
...
mcp__limacharlie__lc_api_call(
  ...
  endpoint="api",
  method="DELETE",
  path="/hive/secret/c7e8f940-1234-5678-abcd-1234567890ab/api-key-v1"
)
```
...
mcp__limacharlie__lc_api_call(
  ...
  endpoint="api",
  method="DELETE",
  path="/hive/secret/c7e8f940-1234-5678-abcd-1234567890ab/test-secret"
)
```
