---
name: yara-scan-directory
description: Recursively scan a directory and its files with YARA rules for malware detection. Takes YARA rule, directory path, file pattern, and recursion depth. Use for bulk malware scanning, threat hunting across file systems, identifying malicious files in directory trees, and comprehensive filesystem analysis during investigations.
allowed-tools: mcp__limacharlie__yara_scan_directory, Read
---
