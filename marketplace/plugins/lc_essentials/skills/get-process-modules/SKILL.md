---
name: get-process-modules
description: Get loaded modules (DLLs, shared libraries) for a specific process including module names, paths, base addresses, and sizes. Use for malware analysis, DLL injection detection, process investigation, suspicious module identification, and understanding process memory layout during security investigations.
allowed-tools: mcp__limacharlie__get_process_modules, Read
---
