---
name: delete-output
description: Delete an output configuration from LimaCharlie to stop data export. Use this skill when users need to remove data routing, disable syslog forwarding, stop S3 archiving, remove webhooks, or deactivate any data export destination. Stops data flow immediately upon deletion. Useful for cleanup, troubleshooting, reconfiguration, or cost reduction.
