---
name: validate-yara-rule
description: Validate YARA rule syntax for correctness before uploading. Perform client-side validation of YARA rule structure, keywords, and basic syntax. Use when users need to test, validate, check, or verify YARA rule syntax, troubleshoot YARA errors, or ensure rule correctness before deployment.
allowed-tools: Read
---
