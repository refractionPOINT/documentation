---
name: get-services
description: Get list of running and configured services from a live sensor including service names, display names, status, startup type, and executable paths. Use for service enumeration, malicious service detection, persistence mechanism identification, and security auditing during investigations.
allowed-tools: mcp__limacharlie__get_services, Read
---
