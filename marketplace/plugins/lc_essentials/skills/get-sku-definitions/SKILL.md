---
name: get-sku-definitions
description: Get SKU (Stock Keeping Unit) definitions and pricing information for LimaCharlie services and features. Use this skill when reviewing available plans, understanding pricing tiers, checking feature costs, planning budgets, or evaluating service options. Returns comprehensive pricing catalog for all LimaCharlie products and add-ons.
