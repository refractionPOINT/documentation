---
name: delete-cloud-sensor
description: Delete a cloud sensor configuration from a LimaCharlie organization. Cloud sensors are integrations that collect telemetry from cloud platforms and SaaS services. Use this skill when users need to remove cloud sensor integrations, decommission cloud data sources, clean up unused cloud sensors, stop collecting data from specific cloud platforms, or manage cloud sensor lifecycle. Requires the sensor name to identify which cloud sensor to delete. Permanent operation that stops data collection from the specified cloud source.
