---
name: set-yara-rule
description: Create or update a YARA rule for malware detection and file scanning. Upload YARA signatures and rule definitions to detect threats across sensors. Use when users need to add, update, create, deploy, or configure YARA rules for malware hunting, threat detection, or file analysis.
