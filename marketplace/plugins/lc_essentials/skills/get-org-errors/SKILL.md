---
name: get-org-errors
description: Get error logs and issues for a LimaCharlie organization including configuration errors, service failures, integration problems, and system warnings. Use this skill when troubleshooting issues, debugging configurations, monitoring org health, or investigating service disruptions.
...
mcp__limacharlie__lc_api_call(
  ...
  endpoint="api",
  method="GET",
  path="/errors/c7e8f940-1234-5678-abcd-1234567890ab"
)
```
