---
name: get-lookup
description: Retrieve a specific lookup table with all its data and metadata from LimaCharlie. Use this skill when users need to see the contents of a threat intelligence feed, allowlist, blocklist, or any reference data table. Returns complete key-value pairs, metadata, tags, and comments. Useful for reviewing enrichment data, auditing threat intel, or inspecting lookup table contents before using in D&R rules.
