---
name: get-historic-events
description: Retrieve historical telemetry events for a specific sensor within a time range. Returns raw sensor events filtered by timestamp and optional event type. Use for forensic timeline analysis, incident investigation, sensor activity review, event correlation, and detailed examination of sensor behavior during specific time periods.
