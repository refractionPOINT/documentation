---
name: get-processes
description: Get real-time process list from a live sensor showing running processes with PIDs, paths, command lines, and parent relationships. Use for live investigation, malware hunting, process analysis, incident response, suspicious process identification, and understanding system state during security investigations.
allowed-tools: mcp__limacharlie__get_processes, Read
---
