---
name: remove-tag
description: Remove a tag from a sensor to update categorization, end investigation tracking, change D&R rule targeting, or clean up temporary labels. Immediately removes the tag without waiting for TTL expiration. Use for sensor re-categorization and tag management.
