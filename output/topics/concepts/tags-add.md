Looking at these documents, I can see they cover **three distinct topics** that should NOT be merged:

1. **Atomic Red Team** - An adversary emulation/security testing tool
2. **Integrity** - A file integrity monitoring (FIM) solution
3. **Add-ons** - A placeholder page with no content

Since these are unrelated concepts under the same category, I'll output them as separate sections:

---

# Atomic Red Team Add-on
...
# Integrity Add-on (File Integrity Monitoring)
