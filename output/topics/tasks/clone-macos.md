...
This document provides details of how to install, verify, and uninstall the LimaCharlie Endpoint Agent on macOS (versions 15 Sequoia and newer). We also offer separate documentation for older versions.
