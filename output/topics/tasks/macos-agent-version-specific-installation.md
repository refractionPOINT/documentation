...
This comprehensive guide covers installation, verification, and uninstallation of the LimaCharlie sensor across all macOS versions, organized by operating system version.
...
#### Verifying Installation (macOS 10.14 and Earlier)
...
#### Uninstallation Flow (macOS 10.14 and Earlier)
...
For the latest macOS 15 Sequoia and newer, please refer to the separate documentation for those versions.
...
#### Verifying Installation (macOS 10.15+)
...
#### Uninstallation Flow (macOS 10.15+)
...
## Common Information Across All Versions
...
- [macOS 10.14 and prior](/v2/docs/macos-agent-installation-older-versions)
- [macOS 10.15 and newer](/v2/docs/clone-macos-agent-installation-latest-versions-macos-15-sequoia-and-newer)
- [macOS Agent Installation with MDM Solutions](/docs/macos-agent-installation-mdm-configuration-profiles)