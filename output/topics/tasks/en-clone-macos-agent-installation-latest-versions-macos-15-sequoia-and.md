...
5. Ensure the toggle for "Allow in the Background" next to "Refraction Point, Inc." is toggled On.

![](https://cdn.document360.io/84ec2311-0e05-4c58-90b9-baa9c041d22b/Images/Documentation/2.5-Login_Items_and_Extensions.png)

6. Click the "i" info icon next to "Endpoint Security Extensions", then ensure the toggle next to "RPHCP" is on.
...
7. After enabling that toggle you'll need to click the "Allow" button to allow RPHCP to filter network content.
