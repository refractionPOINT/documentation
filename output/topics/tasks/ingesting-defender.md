...
This is done by ingesting [artifacts from the Defender Event Log Source](../concepts/artifacts.md) and using [Detection & Response rules](/v2/docs/detection-and-response) to take the appropriate action.

## Configuration Template

A config template to alert on the common Defender events of interest is available [here](https://github.com/refractionPOINT/templates/blob/master/anti-virus/windows-defender.yaml). The template can be used in conjunction with [Infrastructure Extension](../reference/ext-infrastructure.md) or its user interface in the [web app](https://app.limacharlie.io).
