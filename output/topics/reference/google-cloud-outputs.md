# Google Cloud Storage and BigQuery Output Destinations

LimaCharlie supports outputting events and detections to Google Cloud Platform services including Cloud Storage buckets and BigQuery tables.
