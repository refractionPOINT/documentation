...
After providing an [Installation Key](../tasks/installation-keys.md), provide the required values and LimaCharlie will establish a Cloud Adapter for 1Password events
