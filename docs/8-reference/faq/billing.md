...
1. Incident responders will now be able to offer pre-deployments to their customers at almost zero cost. That is, they can deploy across an organization's entire fleet and lay dormant in [sleeper mode](../../2-sensors-deployment/endpoint-agent/sleeper.md). With agents deployed ahead of an incident, responders can offer competitive SLA's.
