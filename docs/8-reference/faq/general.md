...
We suggest you set up an [Output](../../5-integrations/outputs/index.md) to send logs to an external destination if you are looking to have your logs stored for over one year.
