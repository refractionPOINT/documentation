...
Isolates the sensor from the network in a persistent fashion (if the sensor/host reboots, it will remain isolated). Only works on platforms supporting the `segregate_network` [sensor command](../../Sensors/Endpoint_Agent/Endpoint_Agent_Commands/reference-endpoint-agent-commands.md#segregatenetwork).
...
Seals the sensor in a persistent fashion (if the sensor/host reboots, it will remain sealed). Only works on platforms supporting the `seal` [sensor command](../../Sensors/Endpoint_Agent/Endpoint_Agent_Commands/reference-endpoint-agent-commands.md#seal).
...
> To view all possible commands, see [Endpoint Agent Commands](../../Sensors/Endpoint_Agent/Endpoint_Agent_Commands/reference-endpoint-agent-commands.md)
...
Spawns a Claude AI session to perform automated investigation, analysis, or response actions. See [AI Sessions](../../AI_Sessions/index.md) for full documentation.
...
|-----------|-------------|
| `prompt` | Instructions for Claude. Supports [template strings](../../Events/template-strings-and-transforms.md). |
...
For detailed configuration options, see [D&R-Driven AI Sessions](../../AI_Sessions/dr-sessions.md).
