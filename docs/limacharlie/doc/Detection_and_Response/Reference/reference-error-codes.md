...
The follow error codes are found within various Report (`*_REP`) events found within the [EDR Events](../../Events/Endpoint_Agent_Events_Overview/reference-edr-events.md), often in response to an [endpoint agent command](../../Sensors/Endpoint_Agent/Endpoint_Agent_Commands/reference-endpoint-agent-commands.md).
