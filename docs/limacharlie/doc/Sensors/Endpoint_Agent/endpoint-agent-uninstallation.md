...
For macOS and Windows operating systems, you can uninstall a sensor with the `uninstall` command. More information on that can be found [here](Endpoint_Agent_Commands/endpoint-agent-commands.md#uninstall).
