...
2. Subscribe your tenant to [tor](../../../5-integrations/extensions/limacharlie/lookup-manager.md) lookup (provided at no cost).
3. Configure [AWS CloudTrail](../../../2-sensors-deployment/adapters/types/aws-cloudtrail.md) and [AWS GuardDuty](../../../2-sensors-deployment/adapters/types/aws-guardduty.md) adapters to start collecting AWS audit logs.
