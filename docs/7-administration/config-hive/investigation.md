...
For opinionated guidance on tagging events and detections for SOC investigations, including MITRE ATT&CK mapping and attack chain visualization, see the [Investigation Guide](../../1-getting-started/use-cases/investigation-guide.md).

## Related

* [Investigation Guide](../../1-getting-started/use-cases/investigation-guide.md) - Best practices for tagging and documenting investigations
