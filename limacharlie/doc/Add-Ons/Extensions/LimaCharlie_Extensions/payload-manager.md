...
[Payloads](../../../Sensors/Endpoint_Agent/payloads.md), such as scripts, pre-built binaries, or other files, can be deployed to LimaCharlie sensors for any reason necessary.
