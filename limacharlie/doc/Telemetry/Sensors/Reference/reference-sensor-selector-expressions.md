...
* `plat`: the Platform name (see [platforms](../../../Sensors/Reference/reference-id-schema.md#platforms))
* `ext_plat`: the Extended Platform name (see [platforms](../../../Sensors/Reference/reference-id-schema.md#platforms))
