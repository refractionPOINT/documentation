...
* `secret_key`: an arbitrary shared secret used to compute an HMAC (SHA256) signature of the webhook to verify authenticity. This is a required field. [See "Webhook Details" section.](../../Destinations/outputs-destinations-webhook.md#webhook-details)
