...
Events that are emitted once per period per cloud adapter. See [Reference: Schedule Events](reference-schedule-events.md) for more details.
...
Events that are emitted once per period per org. See [Reference: Schedule Events](reference-schedule-events.md) for more details.
...
Events that are emitted once per period per Sensor. See [Reference: Schedule Events](reference-schedule-events.md) for more details.
