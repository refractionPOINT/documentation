...
Events that are emitted once per period per cloud adapter. See [Schedule Events Reference](reference-schedule-events.md) for more details.
...
Events that are emitted once per period per org. See [Schedule Events Reference](reference-schedule-events.md) for more details.
...
Events that are emitted once per period per Sensor. See [Schedule Events Reference](reference-schedule-events.md) for more details.
