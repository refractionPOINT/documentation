...
> For samples of each `deployment` event type, see [Reference: Platform Events](../../Events/Platform_Events_Overview/reference-platform-events.md).
...
> For samples of `ingest` and `export_complete`, see [Reference: Platform Events](../../Events/Platform_Events_Overview/reference-platform-events.md).
...
For more information, see [Reference: Schedule Events](../../Events/Platform_Events_Overview/reference-schedule-events.md)
...
Billing events are generated by the LimaCharlie platform and are related to aspects of the platform such as quotas, thresholds, and other cost-associated events. For an example, see the [Usage Alerts Extension](../../Add-Ons/Extensions/LimaCharlie_Extensions/ext-usage-alerts.md) documentation
