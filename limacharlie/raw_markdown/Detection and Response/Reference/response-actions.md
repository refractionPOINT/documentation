...
breadcrumb: Detection and Response > Reference
source: https://docs.limacharlie.io/docs/response-actions
articleId: 85b03b45-98b2-4d09-ac96-c98e98154ec2
---
...
generated to be visible to chained D&R rules and Services, but the detection will _not_ be sent to the Outputs for storage.
...
###### What's Next
  ...
  * [ Platform Management ](/docs/platform-management) __
