---
title: Writing and Testing Rules
slug: writing-and-testing-rules
breadcrumb: Detection and Response
source: https://docs.limacharlie.io/docs/writing-and-testing-rules
articleId: ecc95548-786b-4c85-9798-b3c77e7d6659
---
...
In this case, we only care about [CODE_IDENTITY](/v2/docs/reference-edr-events#codeidentity) events. We also know that  
...
###### What's Next
  ...
  * [ Create a D&R Rule Using a Threat Feed ](/docs/create-a-dr-rule-using-a-threat-feed) __
