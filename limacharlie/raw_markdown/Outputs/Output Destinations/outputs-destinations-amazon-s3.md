---
title: Amazon S3
slug: outputs-destinations-amazon-s3
breadcrumb: Outputs > Output Destinations
source: https://docs.limacharlie.io/docs/outputs-destinations-amazon-s3
articleId: f8ad8481-6449-4f96-89b7-afe90114964f
---
...
If you have your own visualization stack, or you just need the data archived, you can output directly to Amazon S3. This way you don't need any infrastructure.
  ...
  * `is_indexing`: _DEPRECATED_ if set to "true", data is uploaded in a way that makes it searchable.
...
### AWS S3 Configuration
  ...
  6. Input the policy in sample below where you replace the `<<USER_ARN>>` with the ARN name of the user you created and the `<<BUCKET_NAME>>` with the name of the bucket you just created.
...
###### What's Next
  ...
  * [ Apache Kafka ](/docs/outputs-destinations-apache-kafka) __
