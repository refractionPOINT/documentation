---
title: LimaCharlie Core Concepts
slug: limacharlie-core-concepts
breadcrumb: Getting Started
source: https://docs.limacharlie.io/docs/limacharlie-core-concepts
articleId: d0f5c5c8-4af6-4ae1-9c26-3dd5c192c0b0
---
...
You don't _have to_ use the built-in data retention; you can forward data directly to your infrastructure if preferred. However, it is generally much simpler and a better experience to use Insight. If you prefer not to use Insight, go through the next section (Outputs).
