...
breadcrumb: FAQ
source: https://docs.limacharlie.io/docs/faq-troubleshooting
articleId: ee0c001f-401f-4142-b832-ff865167d44b
---
...
For example, the `os_users` Sensor command has two components:
  ...
  * `OS_USERS_REQ` is the _request_ event sent to the Sensor to collect OS user information.

  * `OS_USERS_REP` is the _response_ event sent back by the Sensor containing the information of interest.
...
###### What's Next
  ...
  * [ FAQ - Privacy ](/docs/faq-privacy) __
