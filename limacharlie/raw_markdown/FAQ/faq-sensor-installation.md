---
title: FAQ - Sensor Installation
slug: faq-sensor-installation
breadcrumb: FAQ
source: https://docs.limacharlie.io/docs/faq-sensor-installation
articleId: a09baa18-f726-405a-b020-379b496350f5
---
...
###### What's Next
  ...
  * [ FAQ - Sensor Removal ](/docs/sensor-removal) __
...
Table of contents
    ...
    * How can I add LimaCharlie traffic to an allow list? 
    * What Hostnames and IPs does LimaCharlie use for each region? 
    * How much data does the LimaCharlie {{glossary.Sensor}} produce per day? 
    * What resources does the LimaCharlie agent consume? 
    * Why does my sensor initially connect successfully but then disappear? 
    * What happens if a host is offline? 
    * How can I tell which {{glossary.Installation Key}} was used to enroll a sensor? 
