---
title: Hayabusa to BigQuery
slug: hayabusa-to-bigquery
breadcrumb: Add-Ons > Extensions > Tutorials
source: https://docs.limacharlie.io/docs/hayabusa-to-bigquery
articleId: a93d7af9-f894-4229-9b44-188b211ad93e
---
  ...
  3. Now we're ready to create our LimaCharlie Events Output
    ...
    1. In the side navigation menu, click "Outputs" then add a new ouput
      ...
      2. **Destination** : Google Cloud BigQuery
        ...
        5. **Project** : _your_ GCP _project name_
...
###### What's Next
  ...
  * [ Velociraptor to BigQuery ](/docs/velociraptor-to-bigquery) __
