---
title: Velociraptor to BigQuery
slug: velociraptor-to-bigquery
breadcrumb: Add-Ons > Extensions > Tutorials
source: https://docs.limacharlie.io/docs/velociraptor-to-bigquery
articleId: 76661e40-7f1a-404f-8d41-aeff1190375f
---
  ...
  3. Now we're ready to create our LimaCharlie tailored output
    ...
    1. In the side navigation menu, click "Outputs" then add a new output
      ...
      2. **Destination** : Google Cloud BigQuery
        ...
        3. **Dataset** : _whatever you named BQ your dataset above_

        4. **Table** : _whatever you named your BQ table above_

        5. **Project** : _your GCP project name_

        6. **Secret Key** : _provide the JSON secret key for your GCP service account_
...
###### What's Next
  ...
  * [ Using Extensions ](/docs/using-extensions) __
