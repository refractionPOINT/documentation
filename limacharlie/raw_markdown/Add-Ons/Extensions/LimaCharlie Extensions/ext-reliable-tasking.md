...
slug: ext-reliable-tasking
breadcrumb: Add-Ons > Extensions > LimaCharlie Extensions
source: https://docs.limacharlie.io/docs/ext-reliable-tasking
articleId: 66d7500a-4ba7-4b8b-95f8-10d0623e8d25
---
...
###### What's Next
  ...
  * [ Sensor Cull ](/docs/ext-sensor-cull) __
...
Table of contents
    ...
    * Actions via REST API 
    * Capturing Task Responses 
    * Migrating {{glossary.D&amp;R}} Rule from legacy Service to new Extension 
