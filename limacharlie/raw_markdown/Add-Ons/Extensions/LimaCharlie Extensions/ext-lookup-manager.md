...
![](https://cdn.document360.io/84ec2311-0e05-4c58-90b9-baa9c041d22b/Images/Documentation/image(279).png)
...
Giving the lookup configuration a name, the URL _or_ [ARL](../../Reference/reference-authentication-resource-locator.md), and clicking the Save button will create the new lookup source to sync to your lookups.
