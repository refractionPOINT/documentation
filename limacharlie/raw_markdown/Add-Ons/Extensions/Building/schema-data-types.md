...
slug: schema-data-types
breadcrumb: Add-Ons > Extensions > Building
source: https://docs.limacharlie.io/docs/schema-data-types
articleId: 000fd530-488b-4d38-9a6a-a46eb739f404
---
...
complex_enum| a complex enum allows for a more detailed enum selection, including categories and description. Requires the field `complex_enum_values`  
...
url|   
domain|   
yara_rule_name| Will show your Organization's list of yara rules available, if the user has permission  
event_name|   
...
###### What's Next
  ...
  * [ Building the User Interface ](/docs/building-the-user-interface) __
