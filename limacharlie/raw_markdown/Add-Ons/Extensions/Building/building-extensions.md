...
source: https://docs.limacharlie.io/docs/building-extensions
articleId: fcc3b4d2-0d61-4bc9-a568-b56c43c205e1
---
...
Every Request Schema exists as a key value pair of the request name, and a corresponding schema contents. The critical contents include the following fields:
  ...
  * **parameters** : This contains the data_type and other fields _(recall the same fields format as the config schema)_
...
###### What's Next
  ...
  * [ Schema Data Types ](/docs/schema-data-types) __



Table of contents

    * Why {{glossary.Extensions}}? 
    * High Level Structure 
    * Getting Started 
    * Simplified Frameworks 
