...
Extension Configurations are records in [Hive](../../Platform%20Management/Config%20Hive/config-hive-lookups.md). Each Extension has its configuration in the Hive record of the same name in the `extension_configuration` Hive.
...
[Detection & Response Rules](../../Detection%20and%20Response/detection-and-response-examples.md), the main automation mechanism in LimaCharlie can interact with Extensions using the `extension request` action in the Response component.
