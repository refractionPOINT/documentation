---
title: Config Hive: Detection & Response Rules
slug: config-hive-dr-rules
breadcrumb: Platform Management > Config Hive
source: https://docs.limacharlie.io/docs/config-hive-dr-rules
articleId: b730df03-5cbd-4135-820a-cd12f667508a
---
...
###### What's Next
  ...
  * [ Config Hive: Lookups ](/docs/config-hive-lookups) __
