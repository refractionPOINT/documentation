...
Adapter Type: `imap`
  ...
  * `attachment_ingest_key`: if specified, an [Ingestion Key](../../../Platform Management/Access and Permissions/api-keys.md) used to ingest attachment as Artifacts into LimaCharlie.
