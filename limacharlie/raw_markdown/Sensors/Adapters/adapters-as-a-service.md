...
Your adapter command may differ depending on your use case--this is an example of a [file](Adapter%20Types/adapter-types-file.md) adapter to ingest logs from a JSON file.
