...
This is done by ingesting [artifacts from the Defender Event Log Source](../../../Events/Platform%20Events%20Overview/reference-platform-events.md) and using [Detection & Response rules](../../../Detection%20and%20Response/detection-and-response-examples.md) to take the appropriate action.

A config template to alert on the common Defender events of interest is available [here](https://github.com/refractionPOINT/templates/blob/master/anti-virus/windows-defender.yaml). The template can be used in conjunction with [Infrastructure Extension](../../../Add-Ons/Extensions/LimaCharlie%20Extensions/ext-infrastructure.md) or its user interface in the [web app](https://app.limacharlie.io).
