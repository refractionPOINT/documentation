...
We recommend first creating a [custom MSI installer](../Windows%20Agent%20Installation/building-a-custom-msi-installer-for-windows.md), bundled with the appropriate installation key, and then including that in your `.intunewin` file.
