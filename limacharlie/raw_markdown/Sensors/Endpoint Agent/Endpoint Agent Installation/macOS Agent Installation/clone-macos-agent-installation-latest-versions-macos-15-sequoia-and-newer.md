---
title: macOS Agent Installation - Latest Versions (macOS 15 Sequoia and newer)
slug: clone-macos-agent-installation-latest-versions-macos-15-sequoia-and-newer
breadcrumb: Sensors > Endpoint Agent > Endpoint Agent Installation > macOS Agent Installation
source: https://docs.limacharlie.io/docs/clone-macos-agent-installation-latest-versions-macos-15-sequoia-and-newer
articleId: 3bd4b3c5-d35e-4e2d-bf43-eccc24c45fff
---
...
###### What's Next
  ...
  * [ macOS Agent Installation via Microsoft Intune ](/docs/macos-agent-installation-via-microsoft-intune) __



Table of contents

    * macOS {{glossary.Sensor}} (macOS 15 Sequoia) 
