---
title: macOS Agent Installation - Older Versions (macOS 10.14 and prior)
slug: macos-agent-installation-older-versions
breadcrumb: Sensors > Endpoint Agent > Endpoint Agent Installation > macOS Agent Installation
source: https://docs.limacharlie.io/docs/macos-agent-installation-older-versions
articleId: 72d81c3b-02c6-4669-8e83-bda25374e367
---
...
###### What's Next
  ...
  * [ macOS Agent Installation - MDM Configuration Profiles ](/docs/macos-agent-installation-mdm-configuration-profiles) __



Table of contents

    * macOS {{glossary.Sensor}} (macOS 10.14 and prior) 
    * Verifying Installation 
    * Uninstallation Flow 
