---
title: macOS Agent Installation via Microsoft Intune
slug: macos-agent-installation-via-microsoft-intune
breadcrumb: Sensors > Endpoint Agent > Endpoint Agent Installation > macOS Agent Installation
source: https://docs.limacharlie.io/docs/macos-agent-installation-via-microsoft-intune
articleId: c6c5c434-3ce7-4348-b409-2714d16cd967
---
...
###### What's Next
  ...
  * [ macOS Agent Installation - Older Versions (macOS 10.15 Catalina to macOS 14 Sonoma) ](/docs/macos-agent-installation-latest-os-versions) __
