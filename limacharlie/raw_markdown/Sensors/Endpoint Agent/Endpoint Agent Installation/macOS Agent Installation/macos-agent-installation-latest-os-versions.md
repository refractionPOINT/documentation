---
title: macOS Agent Installation - Older Versions (macOS 10.15 Catalina to macOS 14 Sonoma)
slug: macos-agent-installation-latest-os-versions
breadcrumb: Sensors > Endpoint Agent > Endpoint Agent Installation > macOS Agent Installation
source: https://docs.limacharlie.io/docs/macos-agent-installation-latest-os-versions
articleId: 9bc1be9b-5055-424a-9f5a-72e4c4135004
---
...
###### What's Next
  ...
  * [ macOS Agent Installation - Older Versions (macOS 10.14 and prior) ](/docs/macos-agent-installation-older-versions) __



Table of contents

    * macOS {{glossary.Sensor}} (macOS 10.15 Catalina to macOS 14 Sonoma) 
