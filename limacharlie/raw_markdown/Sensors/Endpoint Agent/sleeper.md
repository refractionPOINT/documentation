...
The changes to sleeper mode go into effect without the need for a reboot. In sleeper mode, activities such as read other process' memory (e.g. [YARA](../../Add-Ons/Extensions/Third-Party%20Extensions/ext-yara.md)) will stop.
