...
For macOS and Windows operating systems, you can uninstall a sensor with the `uninstall` command. More information on that can be found [here](../Endpoint%20Agent%20Commands/reference-endpoint-agent-commands.md#uninstall).
