...
This directory contains **20 specialized skills** that provide Claude with expert-level knowledge for working with LimaCharlie's endpoint detection and response (EDR), cloud security monitoring, threat hunting, and incident response capabilities.
...
→ Activates: cloud-security-monitor, adapter-configurator
```
