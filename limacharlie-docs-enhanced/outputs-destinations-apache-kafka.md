...
**Note on authentication:** if you specify `username` and `password`, the authentication mechanism assumed is SASL\_SSL + SCRAM-SHA-512, which should be compatible with services like [AWS Manages Streaming Kafka](https://aws.amazon.com/msk/). If you require different paramaters around authentication please contact us at support@limacharlie.io.
